...
export async function POST(req: NextRequest) {
  const { link, details, giftListId, userId, name, price, currency } = await req.json();
  ...
  try {
    const newGift = await processGift(link, details, giftListId, userId, name, price, currency);
